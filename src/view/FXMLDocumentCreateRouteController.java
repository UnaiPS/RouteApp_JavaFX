...
/**
 * FXML Controller class for the Create Route window
 *
...
public class FXMLDocumentCreateRouteController {
    ...
    public void initStage(Parent root) {
        ...
        tvDestinations.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent t) {
                if (t.getButton() == MouseButton.SECONDARY) {
                    cm.show(tvDestinations, t.getScreenX(), t.getScreenY());
                }
            }
        });
        ...
        btnCheckOrigin.setOnKeyPressed(new EventHandler<KeyEvent>() {
            ...
            public void handle(KeyEvent ke) {
                if (ke.getCode().equals(KeyCode.ENTER)) {
                    handleOriginButtonAction(event);
                }
            }
        });
        ...
        btnCheckDestination.setOnKeyPressed(new EventHandler<KeyEvent>() {
            ...
            public void handle(KeyEvent ke) {
                if (ke.getCode().equals(KeyCode.ENTER)) {
                    handleDestinationButtonAction(event);
                }
            }
        });
            ...
            public void handle(KeyEvent ke) {
                if (ke.getCode().equals(KeyCode.ENTER)) {
                    if (cbEnableTrafficMode.isSelected()) {
                        ...
                        cbEnableTrafficMode.setSelected(true);
                    }
                }
            }
        });
    ...
    public void handleWindowShowing(WindowEvent event) {
        ...
        cbDontAssignYet.selectedProperty().addListener(new ChangeListener<Boolean>() {
             ...
             * checked, the combobox will be disabled so the user can't pick
             * one. Otherwise, the delivery property will be set to null.
             *
             * @param observable
             * @param oldValue
             * @param newValue
    ...
    private void handleSaveButtonAction(ActionEvent event) {
        ...
        if (cbEnableTrafficMode.isSelected()) {
            ...
            route.setTrafficMode(TrafficMode.DISABLED);
        }
    ...
    /**
     * This method handles the actions when the user click the return button of
     * the window
     *
     * @param action Object of type WindowEvent
     */
    @FXML
